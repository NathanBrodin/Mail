const stats = [
  { id: 1, name: 'Users', value: '100' },
  { id: 2, name: 'Mails send', value: '12,000' },
  { id: 3, name: 'Mails received', value: '8,000' },
];
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <dl className="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3">
            {stats.map((stat) => (
              <div
                key={stat.id}
                className="mx-auto flex max-w-xs flex-col gap-y-4 hover:scale-110 transition-all"
              >
